...
public class AugurWorksLogDNAAppender extends UnsynchronizedAppenderBase<ILoggingEvent>
{
    ...
    public AugurWorksLogDNAAppender() {
        try {
    ...
    protected void append(ILoggingEvent ev)
    {
        ...
        try
        {
            ...
            this.additionalFields.entrySet().forEach(entry -> {
